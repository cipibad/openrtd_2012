...
#define __KERNEL_SOURCE__ "/mnt/toolchain_build/buildroot/toolchain_build_mipsel_nofpu/linux"
 ...
 */
#define __CROSS_COMPILER_PREFIX__ "/mnt/toolchain_build/buildroot/build_mipsel_nofpu/staging_dir/usr/bin/mipsel-linux-uclibc-"
#undef __DODEBUG__
